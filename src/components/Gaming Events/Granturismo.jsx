...
import banner from "../../assets/gt7.jpg";
  ...
  return (
    <section className="bg-[#0A0A0B] overflow-x-hidden">
      ...
      >
        ...
        <a
          href="h"
          className="text-focus-in w-[150px] h-[47px] pl-[3px] pr-[13px] mr-[5rem] bg-[#D60000] from-zinc-950  rounded-full shadow border border-[#D60000] justify-start items-center inline-flex instagram-button mb-[0.5rem]"
        >
          ...
          <div className="flex mx-auto justify-center items-center">
            <div className="flex justify-center items-center gt7-btn cursor-pointer absolute z-10 mx-auto bottom-[4rem]">
              <div className="flex justify-center">
                <div className="w-[235px] h-[65px] text-center flex flex-row justify-center items-center left-0 top-0 bg-[#D60000] rounded-[100px]">
      ...
      <div className="flex flex-col justify-center gap-[40px] items-center max-w-[1000px] mx-auto mt-[3rem] mb-20">
        <div className="text-[21px] font-readex text-center text-[#D4D4D4] tracking-[1.15px] font-medium z-10 bottom-8 ">
      ...
      <div className="flex flex-col items-center text-center ">
        <div className="relative flex text-start flex-col items-center justify-center">
          ...
          <div className="w-[340px] h-[20px] translate-y-[-4.2rem] bg-gradient-to-r from-zinc-950 to-red-600" />
          ...
          <div className="w-[520px] h-[20px] translate-y-[-9rem] bg-gradient-to-r from-zinc-950 to-red-600" />
          ...
          <div className="w-[680px] h-[20px] translate-y-[-6.3rem] bg-gradient-to-r from-zinc-950 to-red-600" />
          <div className="w-[711px] h-[20px] translate-y-[-10rem] bg-gradient-to-r from-zinc-950 to-red-600" />
        </div>
      </div>
