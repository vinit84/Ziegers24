...
import banner from "../../assets/bgmibanner2.svg";
  ...
  return (
    <div className="wrapper ">
      ...
      >
        ...
        <a
          href="h"
          className="text-focus-in w-[150px] h-[47px] pl-[3px] pr-[13px] mr-[5rem] bg-[#D4C8BD] from-zinc-950  rounded-full shadow border border-[#B5B5B5] justify-start items-center inline-flex instagram-button mb-[0.5rem]"
        >
          ...
          <div className="relative flex justify-center">
            <div className="flex justify-center bgmi-btn cursor-pointer absolute z-10 mx-auto bottom-[5.5rem]">
              <div className="flex justify-center ">
                <div className="w-[235px] h-[65px] text-center flex flex-row items-center  left-0 top-0 bg-[#D4C8BD] rounded-[100px] ">
      ...
      <div className="flex flex-col justify-center gap-[40px] items-center max-w-[950px] mx-auto mt-40 mb-20">
        ...
        <div className="bgmimaps flex flex-row justify-center gap-10 flex-wrap px-5">
          <div>
            <img src={erangle} alt="erangle" className="w-[420px] h-[250px]" />
            <div></div>
          </div>
          <div>
            <img src={vikendi} alt="vikendi" className="w-[420px] h-[250px]" />
          </div>
          <div>
            <img src={miramar} alt="miramar" className="w-[420px] h-[250px]" />
          </div>
          <div>
            <img src={sanhok} alt="sanhok" className="w-[420px] h-[250px]" />
          </div>
        </div>
        <div className="text-[25px] font-readex text-center text-[#D4D4D4] tracking-[1.15px] font-semibold">
