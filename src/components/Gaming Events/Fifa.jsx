...
import banner from "../../assets/fifabanner.png";
  ...
  return (
    <div className="wrapper ">
      ...
      >
        ...
        <a
          href="h"
          className="text-focus-in w-[150px] h-[47px] pl-[3px] pr-[13px] mr-[5rem] bg-[#0083DD] from-zinc-950  rounded-full shadow border border-[#0083DD] justify-start items-center inline-flex instagram-button mb-[0.5rem]"
        >
          ...
          <div className="relative flex justify-center">
            <div className="flex justify-center fifa-btn cursor-pointer absolute z-10 mx-auto bottom-[5.5rem]">
              <div className="flex justify-center">
                <div className="w-[235px] h-[65px] text-center flex flex-row justify-center items-center left-0 top-0 bg-[#0080D8] rounded-[100px]">
      ...
      <div className="flex flex-col justify-center gap-[40px] items-center max-w-[950px] mx-auto mt-40 mb-20">
        <div className="text-[21px] font-readex text-center text-[#D4D4D4] tracking-[1.15px] font-medium z-10">
          <p className="pb-3">
            FIFA 2023 tournament is a competitive for the best players competing
            against each other in EA Sports' latest iteration of the popular
            FIFA series. The tournament will be held on the PlayStation 5
            console, utilizing the advanced features and capabilities of the
            system to provide an immersive and exciting gaming experience. The
            tournament will feature a variety of teams and players, with a prize
            pool for the winner. The tournament aims to bring together the best
            players and fans of FIFA series to showcase their skills and enjoy
            the game together.
          </p>
        </div>
        ...
        <div className="valorantmapselection w-[950px]">
          <div className="p-[10px] flex flex-col gap-3 text-[#D4D4D4] tracking-[1.15px] text-[20px] font-inter text-center">
            <ul
              className="flex flex-col gap-3 items-start text-start max-w-[430px] mx-auto p-5"
              style={{ listStyleType: "disc" }}
            >
              <li> 1v1 between participants will be there</li>
              <li> 5min half</li>
              <li> difficulty level : ultimate</li>
              <li>
                {" "}
                each participant gets to select A single team for the whole
                tournament{" "}
              </li>
              <li> only 3 substitute allowed in the whole match</li>
              <li> if 2 participant select same team coin toss to decide</li>
            </ul>
          </div>
        </div>
