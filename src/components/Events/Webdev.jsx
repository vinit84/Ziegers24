...
import { redirectToWebdesignForm } from "../redirect";
import Webdevloader from "../Webdevloader";
    ...
    <div className="wrapper">
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="m-hide text-focus-in w-[150px] h-[47px] pl-[3px] pr-[13px] mr-[5rem] bg-[#246DB6] from-zinc-950  rounded-full shadow border border-[#246DB6] justify-start items-center inline-flex instagram-button mb-[0.5rem]"
        >
          ...
          <div className="relative flex justify-center">
            <div className="flex justify-center webdev-btn cursor-pointer absolute z-10 mx-auto bottom-[7.2rem]">
              <div className="flex justify-center">
                <div onClick={redirectToWebdesignForm} className="w-[235px] h-[65px] text-center flex flex-row justify-center items-center left-0 top-0 bg-[#246DB6] rounded-[100px] m-webdev-btn">
                  <div
...
export default transition(Webdev);
